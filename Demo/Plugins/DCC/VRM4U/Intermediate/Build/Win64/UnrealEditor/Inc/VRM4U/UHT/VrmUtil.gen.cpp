...
template<> VRM4U_API UScriptStruct* StaticStruct<FImportOptionData>()
{
	...
	struct Z_CompiledInDeferFile_FID_Demo_Plugins_DCC_VRM4U_Source_VRM4U_Public_VrmUtil_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Demo_Plugins_DCC_VRM4U_Source_VRM4U_Public_VrmUtil_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Demo_Plugins_DCC_VRM4U_Source_VRM4U_Public_VrmUtil_h_Statics::ScriptStructInfo[] = {
		{ FImportOptionData::StaticStruct, Z_Construct_UScriptStruct_FImportOptionData_Statics::NewStructOps, TEXT("ImportOptionData"), &Z_Registration_Info_UScriptStruct_ImportOptionData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FImportOptionData), 742516652U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Demo_Plugins_DCC_VRM4U_Source_VRM4U_Public_VrmUtil_h_3793096868(TEXT("/Script/VRM4U"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Demo_Plugins_DCC_VRM4U_Source_VRM4U_Public_VrmUtil_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Demo_Plugins_DCC_VRM4U_Source_VRM4U_Public_VrmUtil_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Demo_Plugins_DCC_VRM4U_Source_VRM4U_Public_VrmUtil_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Demo_Plugins_DCC_VRM4U_Source_VRM4U_Public_VrmUtil_h_Statics::EnumInfo));
